...
public:
    ...
    void backwardPass(vector<double> input, vector<int> label);
    vector<double> train(vector<vector<double>> &data, vector<vector<int>> &labels, int iter_number, double learning_rate,
    ...
    double get_loss(vector<double> x, vector<int> y);
